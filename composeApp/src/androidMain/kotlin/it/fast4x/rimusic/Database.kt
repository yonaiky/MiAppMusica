...
interface Database {
    ...
    @Query("""
        ...
        ORDER BY Song.ROWID
    """)
    fun sortFavoriteSongEntityByRowId(): Flow<List<SongEntity>>
    ...
    """)
    fun sortFavoriteSongsByPlayTime(): Flow<List<Song>>

    fun sortFavoriteSongsByRelativePlayTime(): Flow<List<Song>> =
        sortFavoriteSongsByPlayTime().map {
    ...
    @Query("""
        ...
        COLLATE NOCASE
    """)
    fun sortFavoriteSongsByTitle(): Flow<List<Song>>
    ...
    @Query("""
        ...
        ORDER BY Song.ROWID
    """)
    fun sortFavoriteSongsByRowId(): Flow<List<Song>>
    ...
    @Query("""
        ...
        ORDER BY E.timestamp
    """)
    fun sortFavoriteSongsByDatePlayed(): Flow<List<Song>>
    ...
    @Query("""
        ...
        ORDER BY likedAt
    """)
    fun sortFavoriteSongsByLikedAt(): Flow<List<Song>>
    ...
    """)
    fun sortFavoriteSongsByArtist(): Flow<List<Song>>
    ...
    """)
    fun sortFavoriteSongsByDuration(): Flow<List<Song>>
    ...
    """)
    fun sortFavoriteSongsByAlbum(): Flow<List<Song>>
     ...
     * @see SortOrder
     */
    fun findFavoriteSongs( sortBy: SongSortBy, sortOrder: SortOrder ): Flow<List<Song>> =
        when (sortBy) {
            SongSortBy.PlayTime         -> sortFavoriteSongsByPlayTime()
            SongSortBy.RelativePlayTime -> sortFavoriteSongsByRelativePlayTime()
    ...
    //<editor-fold defaultstate="collapsed" desc="Find offline songs">
    @Query("""
        SELECT DISTINCT Song.*, Format.contentLength, Album.title
        FROM Song 
        LEFT JOIN SongAlbumMap ON Song.id = SongAlbumMap.songId 
        ...
        ORDER BY totalPlayTimeMs
    """)
    fun sortOfflineSongEntityByPlayTime(): Flow<List<SongEntity>>
    ...
    @Query("""
        ...
        ORDER BY totalPlayTimeMs
    """)
    fun sortOfflineSongsByPlayTime(): Flow<List<Song>>

    fun sortOfflineSongsByRelativePlayTime(): Flow<List<Song>> =
        sortOfflineSongsByPlayTime().map {
            it.sortedBy( Song::relativePlayTime )
        }
    ...
    @Query("""
        ...
        COLLATE NOCASE
    """)
    fun sortOfflineSongsByTitle(): Flow<List<Song>>
    ...
    @Query("""
        ...
        ORDER BY Song.ROWID
    """)
    fun sortOfflineSongsByRowId(): Flow<List<Song>>
    ...
    @Query("""
        ...
        ORDER BY E.timestamp
    """)
    fun sortOfflineSongsByDatePlayed(): Flow<List<Song>>
    ...
    """)
    fun sortOfflineSongsByLikedAt(): Flow<List<Song>>
    ...
    """)
    fun sortOfflineSongsByArtist(): Flow<List<Song>>
    ...
    """)
    fun sortOfflineSongsByDuration(): Flow<List<Song>>
    ...
    """)
    fun sortOfflineSongsByAlbum(): Flow<List<Song>>
     ...
     * @see SortOrder
     */
    fun findOfflineSongs( sortBy: SongSortBy, sortOrder: SortOrder ): Flow<List<Song>> =
        when (sortBy) {
            SongSortBy.PlayTime         -> sortOfflineSongsByPlayTime()
            SongSortBy.RelativePlayTime -> sortOfflineSongsByRelativePlayTime()
     ...
     *
     * [filterList] tells SQLite to only accept songs with
     * [Song.id] inside the list. By default, [filterList]
     * is set to null, effectively disable this feature.
     * [emptyList] will accept nothing.
     *
     * @param sortBy which song's property is used to sort
     * @param sortOrder what order should results be in
...
//    fun songsWithAlbumByPlayTimeDesc(showHiddenSongs: Int = 0): Flow<List<SongEntity>>
    ...
    """)
    fun sortSongsFromPlaylistByDateAdded( id: Long ): Flow<List<Song>>
    ...
    fun songsPlaylist(
        ...
        PlaylistSongSortBy.Album -> sortSongsFromPlaylistByAlbum( playlistId )
        PlaylistSongSortBy.AlbumYear -> sortSongsFromPlaylistByAlbumYear( playlistId )
        PlaylistSongSortBy.Artist -> sortSongsFromPlaylistByArtist( playlistId )
        PlaylistSongSortBy.ArtistAndAlbum -> sortSongsFromPlaylistByArtistAndAlbum( playlistId )
        PlaylistSongSortBy.DatePlayed -> sortSongsFromPlaylistByDatePlayed( playlistId )
        PlaylistSongSortBy.PlayTime -> sortSongsFromPlaylistByPlaytime( playlistId )
        PlaylistSongSortBy.RelativePlayTime -> sortSongsFromPlaylistByRelativePlaytime( playlistId )
        PlaylistSongSortBy.Position -> sortSongsPlaylistByPosition( playlistId )
        PlaylistSongSortBy.Title -> sortSongsFromPlaylistByTitle( playlistId )
        ...
        PlaylistSongSortBy.DateAdded -> sortSongsFromPlaylistByDateAdded( playlistId )
    }.map( sortOrder::applyTo )
